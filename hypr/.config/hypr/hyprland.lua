...
hl.on("hyprland.start", function ()
    -- hl.exec_cmd(uwsm("systemctl --user start hyprpolkitagent"))
    hl.exec_cmd(uwsm("swaync"))
    hl.exec_cmd(uwsm("hypridle"))
    hl.exec_cmd(uwsm("elephant"))
    hl.exec_cmd(uwsm("walker --gapplication-service"))
    hl.exec_cmd(uwsm("waybar"))
    hl.exec_cmd(uwsm("flatpak run io.github.linx_systems.ClamUI"))
    hl.exec_cmd(uwsm("snappy-switcher --daemon"))

    -- hl.exec_cmd("gsettings set org.gnome.desktop.interface gtk-theme \"Adwaita\"")   -- for GTK3 apps
...
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(uwsm(browser)))
hl.bind(mainMod .. " + F", hl.dsp.window.fullscreen())
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd(uwsm("hyprlock")))
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd(uwsm("swaync-client -t")))
...
-- Quick launching
hl.bind(mainMod .. " + G", hl.dsp.submap("quickl"))
hl.define_submap("quickl", "reset", function ()
    hl.bind("d", hl.dsp.exec_cmd(uwsm("vivaldi --app=https://discord.com/channels/@me")))
    hl.bind("m", hl.dsp.exec_cmd(uwsm("vivaldi --app=https://messages.google.com/web/conversations")))
    hl.bind("p", hl.dsp.exec_cmd(uwsm("vivaldi --app=https://photos.google.com/")))
    hl.bind("ALT + s", hl.dsp.exec_cmd(uwsm("grimblast save screen")))
